...
func (m *MockStream) NewConsumer(streamName string, cfg messaging.ConsumerConfig) (messaging.Consumer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStream) NewPublisher(streamName string) (messaging.Publisher, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewPublisher", streamName)
	ret0, _ := ret[0].(messaging.Publisher)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
